  ...
  return {
    ...
    controller: function ($scope) {
      ...
      $scope.condition_keys = [
        ...
        {name: 'Is Locked', value: 'is_locked', arguments: [], capabilities: ['lock']},
        {name: 'Is Unlocked', value: 'is_unlocked', arguments: [], capabilities: ['lock']},
        {name: 'Locked Age', value: 'locked_age', arguments: [], capabilities: ['lock']},
        {name: 'Unlocked Age', value: 'locked_age', arguments: [], capabilities: ['lock']},
